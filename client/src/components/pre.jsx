...
import MaterialCard from "../material/Card.jsx";
import TimeLine from "./../material/TimeLine.jsx";
import { Button } from "@/shadcn/ui/button";
import { Switch } from "@headlessui/react";
import QuickReportModal from './../material/QuickReportModal.jsx'

import Accordion from "./../material/Accordion.jsx";
...
const timeline = [
  {
    ...
    Excepturi aspernatur earum cupiditate accusamus distinctio laborum
    eaque suscipit iusto nostrum, quaerat, nobis, possimus quo
    officia? Qui distinctio odit laboriosam dolor velit.`,
  },
  {
    date: new Date().toDateString(),
    image:
...
export function Footer() {
  return (
    <>
      <footer className='bg-[var(--backGround)] text-[var(--heading-light)]'>
        <div className='mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8'>
          <div className='grid grid-cols-1 gap-8 lg:grid-cols-3'>
            <div>
              ...
              <p className='mt-4 max-w-xs text-[var(--heading-trival)]'>
              ...
              <ul className='mt-8 flex gap-6'>
                <li>
                  <a
                    ...
                    rel='noreferrer'
                    target='_blank'
                    className='text-[var(--heading-light)] transition hover:opacity-75'>
            ...
            <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4'>
              <div>
                <p className='font-medium text-[var(--heading-trival)]'>
                  Services
                </p>
          ...
          <p className='text-xs text-[var(--heading-trival)]'>
...
export function Teams() {
  return (
    <div className='py-10 bg-[var(--backGround)]'>
      <h1 className='text-center text-4xl sm:text-5xl font-bold my-10 text-[var(--heading-main)]'>
        People Behind Us
      </h1>
      <div className='grid sm:grid-cols-3 grid-cols-2 justify-items-center gap-5 overflow-x-auto'>
        {teamMembers.map((member, key) => (
          <React.Fragment key={key}>
            <MaterialCard member={member} />
          </React.Fragment>
        ))}
      </div>
    </div>
...
export function QuickSend() {
  return (
    <div className='relative isolate px-6 pt-20 lg:px-8 bg-[var(--backGround)]'>
      <h1 className='text-4xl md:text-5xl text-center font-bold underline text-[var(--heading-main)]'>
        Quick Send
      </h1>
      <div
        ...
        aria-hidden='true'>
        <div
          className='relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[var(--primary-color)] to-[--secondary-color] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]'
          style={{
            clipPath:
      ...
      <div className='mx-auto max-w-2xl py-24 sm:py-32 lg:py-40'>
        ...
        <div className='text-center'>
          <h1 className='text-4xl font-bold tracking-tight text-[var(--heading-main)] sm:text-6xl'>
          Breaking Silence: Empowering Women to Speak Out
          </h1>
          <p className='mt-6 text-lg leading-8 text-[var(--heading-trival)]'>
          In a world where silence often shrouds the voices of the oppressed, "Breaking Silence" emerges as a beacon of hope, a platform dedicated to empowering women to raise their voices, share their stories, and break free from the chains of silence. 
          </p>
...
export function Contact() {
  ...
  return (
    <div className='isolate bg-[var(--backGround)] px-6 py-24 sm:py-32 lg:px-8'>
      <div
      ...
      <div className='mx-auto max-w-2xl text-center'>
        <h2 className='text-3xl font-bold tracking-tight text-[var(--heading-trival)] sm:text-4xl'>
          Contact sales
        </h2>
        <p className='mt-2 text-lg leading-8 text-[var(--heading-light)]'>
      ...
      <form
        ...
        <div className='grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2'>
          <div>
            <label
              htmlFor='first-name'
              className='block text-sm font-semibold leading-6 text-[var(--heading-light)]'>
              First name
            </label>
            <div className='mt-2.5'>
              <input
                ...
                className='block w-full rounded-md border-0 px-3.5 py-2 text-[var(--heading-light)] shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 bg-[var(--backGround)]'
              />
            </div>
          </div>
          <div>
            ...
            <div className='relative mt-2.5'>
              <div className='absolute inset-y-0 left-0 flex items-center'>
                ...
                <select
                  ...
                  id='country'
                  name='country'
                  className='h-full rounded-md border-0 bg-none py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm bg-[var(--backGround)]'>
              ...
              <input
                ...
                id='phone-number'
                autoComplete='tel'
                className='block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-[var(--heading-light)] shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 bg-[var(--backGround)]'
              />
            </div>
          </div>
          <div className='sm:col-span-2'>
...
export default function Pre() {
  return (
    <div className='relative'>
      ...
      {/* <Contact /> */}
      <div className='mx-auto py-10  bg-[var(--backGround)]'>
        <h1 className='text-4xl md:text-5xl my-10 text-center font-bold underline text-[var(--heading-main)]'>
          FAQs
        </h1>
        <Accordion />
      </div>
